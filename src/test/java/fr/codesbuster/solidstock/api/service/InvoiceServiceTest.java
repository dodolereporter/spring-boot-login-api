...
public class InvoiceServiceTest {
    ...
    public void testGenerateInvoice() throws IOException, ParseException {
        ...
        try {
            ...
            deleteInvoiceFile(invoiceEntity);
        }
    }
    ...
    public void testGetInvoice() throws IOException, ParseException {
        ...
        try {
            if (!invoiceService.getInvoicePDF(invoiceEntity).exists()) {
                assertTrue(invoiceService.generateInvoicePDF(invoiceEntity).exists());
            }
        } finally {
            deleteInvoiceFile(invoiceEntity);
    ...
    private void deleteInvoiceFile(InvoiceEntity invoiceEntity) {
        String filePath = System.getProperty("java.io.tmpdir") + File.separator + "SolidStock" + File.separator + "Invoices" + File.separator + "invoice_" + invoiceEntity.getId() + ".pdf";
